...
public class Board {
    ...
    private static int MINSQUARES = 10;

    public Board(int numSquares, int [][] ladders, int [][] snakes){
        assert numSquares > MINSQUARES : "There must be at least " + MINSQUARES + " squares";
    ...
    private void makeSnakes(int[][] snakes) {
        for (int i = 0; i < snakes.length; i++){
            ...
            assert (toPosition > 0) && (toPosition < numberOfSquares());
